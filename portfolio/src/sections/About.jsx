    ...
    >
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="relative z-10 max-w-6xl w-full mx-auto px-6 md:px-10 lg:px-12 py-20 flex flex-col gap-12 ">
          ...
          >
            <motion.div className="relative w-[160px] h-[160px] md:w-[200px] md:h-[165px]
            rounded-2xl overflow-hidden shadow-2xl bg-gradient-to-r from-[#1cd8d2]/20 to-[#302b63]/20 border border-[#d49a5f]/25"
...
<img src={p} alt="profile" className="absolute inset-0" />
            ...
            <div className="flex-1 flex flex-col justify-center text-center md:text-left">
              ...
              <p className="mt-4 text-gray-300 leading-relaxed text-base sm:text-lg max-w-2xl md:max-w-3xl">
                 I build scalable , modern applications with a strong focus on clean architecture delightful UX , performance . My toolkit spans react.js , Next.js , Typescript , Taiwind CSS , and RestfulAPI - bringing ideas to life from concept to production with robust APIs and smooth interface. 
              </p>

              <div className="mt-6 grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-4 max-w-xl">
                {stats.map((item, i) => (
                  <motion.div key={i} className="rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-center"
                  intital={{opacity:0 , y:10}}
                  whileInView={{opacity:1 , y:0}}
              ...
              <div className="mt-6 flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center md:justify-start">
                ...
                <p className="text-gray-300 leading-relaxed text-base sm:text-lg"> 
                  I'm a Web Developer - passinonate about building fast , resilient applications and sharing coding insights on Instagram and Youtube.
                </p>
                <p className="mt-4 text-gray-400 text-base sm:text-lg">
                  I love turning Ideas into scaalable , user-friendly products that make an impact .
                </p>
